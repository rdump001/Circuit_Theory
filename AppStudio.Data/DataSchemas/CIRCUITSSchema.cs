...
{
    /// <summary>
    /// Implementation of the CIRCUITSSchema class.
    /// </summary>
    public class CIRCUITSSchema : BindableSchemaBase, IEquatable<CIRCUITSSchema>
    {
        ...
        public bool Equals(CIRCUITSSchema other)
        {
            if (other == null)
            {
                return false;
