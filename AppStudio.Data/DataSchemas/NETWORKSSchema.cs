...
{
    /// <summary>
    /// Implementation of the NETWORKSSchema class.
    /// </summary>
    public class NETWORKSSchema : BindableSchemaBase, IEquatable<NETWORKSSchema>
    {
        ...
        public bool Equals(NETWORKSSchema other)
        {
            if (other == null)
            {
                return false;
